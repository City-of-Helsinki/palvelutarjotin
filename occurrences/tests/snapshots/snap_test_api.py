...
snapshots['test_unenrol_occurrence 1'] = {
    'data': {
        'unenrolOccurrence': {
            ...
            'studyGroup': {
                'unitName': 'Respond yard door indicate.'
            }
        }
    }
}
            ...
            'edges': [
                {
                    'node': {
                        ...
                        'placeId': 'Receive cup teacher subject family around.',
                        'remainingSeats': 14,
                        'seatType': 'CHILDREN_COUNT',
                        'seatsApproved': 0,
                        'seatsTaken': 0,
                ...
                },
                {
                    'node': {
                        ...
                        'placeId': 'Experience seven Republican throw wrong party wall.',
                        'remainingSeats': 4,
                        'seatType': 'CHILDREN_COUNT',
                        'seatsApproved': 0,
                        'seatsTaken': 0,
                ...
                },
                {
                    'node': {
                        ...
                        'placeId': 'Country actually generation five training thought price gas.',
                        'remainingSeats': 3,
                        'seatType': 'CHILDREN_COUNT',
                        'seatsApproved': 0,
                        'seatsTaken': 0,
...
snapshots['test_auto_accept_message_is_used_as_custom_message_in_auto_approved_enrolments 1'] = {
    'data': {
        'enrolOccurrence': {
            'enrolments': [
                {
...
snapshots['test_auto_accept_message_is_used_as_custom_message_in_auto_approved_enrolments 2'] = [
