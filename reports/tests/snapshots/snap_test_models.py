...
snapshots["test_enrolment_report 1"] = {
    ...
    "distance_from_unit_to_event_place": 0.0,
    ...
    "occurrence_place_divisions": ["ocd-division/country:fi/kunta:espoo"],
    "occurrence_place_position": [24.657864, 60.203636],
    ...
    "study_group_unit_divisions": ["ocd-division/country:fi/kunta:espoo"],
    "study_group_unit_id": None,
    "study_group_unit_position": [24.657864, 60.203636],
